...
# to call the script:  tfds build /home/dsi/galgreen/tmp/rfchallenge/dataset_utils/tfds_scripts/create_simulations_dataset_M=50.py --data_dir tfds/
...
class create_simulations_dataset_M_50(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        path = os.path.join('/', 'home', 'dsi', 'galgreen', 'tmp', 'rfchallenge', 'dataset', f'Dataset_{soi_type}_train_Mixture_M=50')
